...
def prepare_data(
    ...
    wav_list = get_all_files(data_original, match_and=extension)
...
if __name__=="__main__":
    data_original=sys.argv[1]
    names = ["train.json", "dev.json", "test.json"]
    save_json_train, save_json_valid, save_json_test = [os.path.join(sys.argv[2], x) for x in names]
